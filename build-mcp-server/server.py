...
async def analyze_file_changes(base_branch: str = "main", 
    ...
    try:
        ...
        # User provided working directory or current directory
        ...
        analysis = {
            ...
            "diff": diff_output if include_diff else "Diff not included (set include_diff=true to see full diff)",
            "truncated": truncated,
